...
public class AdMobManager : MonoBehaviour
{
    ...
    // my test device Huawei Ad id: 1d3ec0a0-422d-46ea-a47d-767c9e328fe4
    // my test device Ouktel Ad id: dfe63381-d89d-4d26-b6b7-5cb68dd1fd97
    // <uses-permission android:name="com.google.android.gms.permission.AD_ID" />
    // ca-app-pub-1754302936861474~8850406350 ---> game id

    // ca-app-pub-1754302936861474/5687510178 ---- ca-app-pub-1754302936861474/6387182471
    private void Awake()
    {        
    ...
    private void Update()
    {
        ...
        if (zaman >= rewardedVideoOtomatikYeniIstekZamani)
        {
            ...
            print(rewardedVideoOtomatikYeniIstekZamani);
            RewardedReklamYukle();
        }
    }
    ...
    public static void RewardedAdDestroy()
    {
        if (instance.rewardedVideoReklam != null)
        {
            instance.rewardedVideoReklam.Destroy();
            instance.rewardedVideoReklam = null;
        }
    }
    ...
    {
        PlayerPrefs.SetString("isNewLevel", "True");
        InterstitialReklamYukle();        
    }

    private void RewardedVideoDelegate(object sender, EventArgs args)
    {
        PlayerPrefs.SetString("isRewardedClose", "True");
        RewardedReklamYukle();        
    }
